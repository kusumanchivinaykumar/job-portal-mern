...
const Hero = () => {
    ...
    return (
        <div>
            ...
            {/* HERO SECTION */}
            <div className='bg-gradient-to-r from-slate-900 to-slate-800 text-white py-16 text-center mx-2 rounded-xl '>
                <div className="mt-20 text-center">
                    ...
                    <div className='flex items-center gap-2 bg-white rounded text-gray-600 max-w-xl mx-auto p-2'>
                        ...
                        <button onClick={onSearch} className='bg-blue-600 hover:bg-blue-700 transition-colors px-6 py-2 rounded text-white'>Search</button>
                    </div>
                </div>
            </div>
